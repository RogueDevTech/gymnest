...
//         <div
//           className="
//           absolute left-0 right-0 bottom-0 px-4 py-6 md:px-6 md:py-14
//           backdrop-blur-[10px]
//           bg-[linear-gradient(0deg,rgba(0,0,0,0.2)_64.67%,rgba(251,204,12,0.02)_116%)]
//           flex flex-col items-center justify-center
//         "
//         >
//           <h3 className="text-lg md:text-2xl font-semibold font-[Kumbh] text-white leading-[110%] mb-2 md:mb-4">
//             {trainer.name}
//           </h3>
