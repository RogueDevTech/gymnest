...
//   return (
//     <div className="lg:px-16 lg:py-22">
//       <div className="my-15">
...
//           <div
//             className="border border-[#E2DFDF] py-6 px-5 shadow-[0px_0px_4px_0px_#0000001A]
...
//           <div className="border border-[#E2DFDF] py-6 px-5 shadow-[0px_0px_4px_0px_#0000001A] h-fit rounded-lg p-5  bg-white sticky top-6">
//             <h3 className="font-semibold font-[Kumbh] text-[20px] leading-none tracking-normal mb-4 text-lg">
//               Order Summary
//             </h3>

//             {/* Product Item */}
//             <div className="flex items-center justify-between gap-4 mb-6">
//               <div className="relative w-12.5 h-12.5 shrink-0 bg-[#F5F5F5]">
//                 <Image
//                   src={product.img}
//                   alt={product.title}
//                   fill
...
//                 <p className="font-[Kumbh] text-base font-normal leading-[110%] tracking-normal text-[#484747]">
...
//                 className="border border-[#DEDEDE] text-black font-[Kumbh] font-normal text-base leading-[110%] tracking-normal rounded-lg p-5 w-full h-11"
//               />
//               <button
//                 onClick={handleApplyDiscount}
//                 className="bg-[#E7E7E7] px-4 rounded-lg hover:bg-gray-800 transition-colors text-base text-[#222222] font-normal"
//               >
//                 Apply
//               </button>
//             </div>
...
//             {/* Checkout Button */}
//             <button className="bg-yellow-500 w-full py-3 rounded font-medium hover:bg-yellow-600 transition-colors">
//               Proceed to Pay
//             </button>
//           </div>
//         </div>
